...
public class RobotValcea2Roti extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if(armMotor.getCurrentPosition() > -4800 && gamepad2.left_stick_y < 0)
                ...
                else armMotor.setPower(gamepad2.left_stick_y/3);
            ...
            power = -gamepad1.left_stick_y / 1.5;
            power2 = gamepad1.right_stick_x / 1.5;
            //backLeftMotor.setPower(power - power2);
            //backRightMotor.setPower(power - power2);
            if(power > 0) {
                backLeftMotor.setPower(power - power2);
                frontLeftMotor.setPower(power - power2);

                backRightMotor.setPower(power + power2);
                frontRightMotor.setPower(power + power2);
            }
            else{
                backLeftMotor.setPower(power + power2);
                frontLeftMotor.setPower(power + power2);
