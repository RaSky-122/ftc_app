...
public class VuforiaTargetDistance_Try1 extends  LinearOpMode
{
    // Constants
    ...
    public void initVuforia() {
        ...
        targets.get(0).setName("Blue Perimeter");
        targets.get(1).setName("Red Perimeter");
        targets.get(2).setName("Front Perimeter");
        targets.get(3).setName("Back Perimter");
