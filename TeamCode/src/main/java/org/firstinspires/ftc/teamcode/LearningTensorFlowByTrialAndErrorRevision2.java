...
@TeleOp(name = "TensorFlowMinerals", group = "Learning")
@Disabled

public class LearningTensorFlowByTrialAndErrorRevision2 extends  LinearOpMode{
                    ...
                    if (updatedRecognitions.size() == 3) {
                        ...
                        for (Recognition recognition : updatedRecognitions) {
                            if (recognition.getLabel().equals(LABEL_GOLD_MINERAL)) {
                                ...
                                //telemetry.addData("Gold confidence: ", goldMineralX);
                            } else if (silverMineral1X == -1) {
                                silverMineral1X = (int) recognition.getLeft();
                                //telemetry.addData("Silver1 confidence: ", silverMineral1X);
                            } else {
                                silverMineral2X = (int) recognition.getLeft();
                                //telemetry.addData("Silver2 confidence: ", silverMineral2X);
                            } }
